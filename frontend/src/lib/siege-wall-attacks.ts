...
export const ATTACK_VECTORS = [
  { id: 'brute-force', name: 'Brute Force', icon: '🔨', color: '#ef4444', generator: bruteForceAttack },
  { id: 'ai-simulation', name: 'AI Pattern Analysis', icon: '🤖', color: '#8b5cf6', generator: aiPatternAttack },
  { id: 'timing', name: 'Timing Attack', icon: '⏱️', color: '#f59e0b', generator: timingAttack },
  { id: 'replay', name: 'Replay Attack', icon: '🔄', color: '#3b82f6', generator: replayAttack },
  { id: 'bot-simulation', name: 'Bot Simulation', icon: '🤖', color: '#ec4899', generator: botSimulationAttack },
  { id: 'sql-injection', name: 'SQL Injection', icon: '💉', color: '#ef4444', generator: sqlInjectionAttack },
  { id: 'quantum-bypass', name: 'Quantum Bypass', icon: '⚛️', color: '#06b6d4', generator: quantumBypassAttack },
  { id: 'celestial-prediction', name: 'Celestial Prediction', icon: '🌟', color: '#a855f7', generator: celestialPredictionAttack },
] as const;

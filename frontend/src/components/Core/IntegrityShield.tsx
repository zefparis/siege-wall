...
export function IntegrityShield() {
  ...
  return (
    <div className="relative flex items-center justify-center">
      {/* Outer glow ring */}
      <motion.div
        className="absolute w-32 h-32 lg:w-48 lg:h-48 rounded-full"
        style={{
      ...
      {/* Hexagon container */}
      <div className="relative hexagon w-28 h-28 lg:w-40 lg:h-40 bg-bg-card border-2 border-cyan/30 flex items-center justify-center">
        {/* Inner glow */}
        <div 
        ...
        >
          <Shield className="w-10 h-10 lg:w-16 lg:h-16 text-cyan" strokeWidth={1.5} />
          <div className="mt-1 lg:mt-2 text-cyan font-display text-xs lg:text-sm tracking-wider">
            HCS-U7
          </div>
        </motion.div>
      ...
      {/* Integrity text */}
      <div className="absolute -bottom-6 lg:-bottom-8 text-center">
        <span className="text-cyan font-mono text-sm lg:text-lg font-bold">
          INTEGRITY: 100%
        </span>
      </div>
